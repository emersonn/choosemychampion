...
var e=t.defer()
return n(function(){e.resolve(r.StartSession(a,--i))},2500),e.promise}return t.reject("oops!")})}}]),e.factory("Champion",["$resource",function(e){return e("/api/stats/:username/:userId",{username:"@username",userId:"@userId"},{query:{method:"GET",params:{username:"@username",userId:"@userId"}}})}]),e.factory("Stats",["$resource",function(e){return e("/api/internal/stats")}]),e.directive("summonerLogin",function(){return{restrict:"E",templateUrl:"main.html"}}),e.directive("filteredChamps",function(){return{restrict:"E",templateUrl:"/static/championList.html",scope:{certainFilter:"="}}}),e.filter("encodeURIComponent",function(){return window.encodeURIComponent})}()
